...
?>
					<div style="border:3px solid #909090;padding:60x;margin:60px;height:270px;">
            ...
            <div style="font-size:18px;width:800px;word-wrap:break-word;"><?php echo $row1['c_desc']?></div></div>
					<a href="<?php echo "Mockpapers/".$row['name'].".pdf"; ?>" style="background-color:#5ac90e;color:white;padding:5px;border:2px solid green;border-radius:5px;position:relative;top:-100px;font-size:16px;left:30px;" download>Download Mock Paper</a>					
				  <a href="<?php echo "./viewonline.php?name=".$row['name'].""; ?>" style="background-color:#5ac90e;color:white;padding:5px;border:2px solid green;border-radius:5px;position:relative;top:-100px;font-size:16px;left:40px;" >View Online Paper</a>          
        
          <a href="<?php echo "Mockpapers/".$row['name']."-s.pdf"; ?>" style="background-color:#5ac90e;color:white;padding:5px;border:2px solid green;border-radius:5px;position:relative;top:-100px;font-size:16px;left:390px;" download>Download Answer Key</a>               
					<a href="<?php echo "./viewonline.php?name=".$row['name']."-s"; ?>" style="background-color:#5ac90e;color:white;padding:5px;border:2px solid green;border-radius:5px;position:relative;top:-100px;font-size:16px;left:400px;" >View Online Answers</a>								
					</div>
<?php
	}	
?>	
