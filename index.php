...
ddsmoothmenu.init({
  ...
  <body>
      ...
      <div class="container templatemo_container">
        <div class="row">
          <div class="col-sm-3 col-md-3">
            <div class="logo">
              <a rel="nofollow" href="./index.php"><img src="images/templatemo_logo.png" alt="logo"></a>
            </div>
          </div>
    ...
    <div class="templatemo_reasonbg">
    	<h2>About Us</h2>
       		<center><p style="width:700px;">PlacementCentral  is an  all in one placement preparation portal where you can learn and solve 
a variety of questions .PlacementCentral gives you quizzes to practice  , learn and evaluate your c, c++ , Java skills 
and a lot more general quizzes to go through  your entire course .
One can download  company wise  written  question papers    as well as answers . 
PlacementCentral also provides with a large number of interview questions asked in variety of companies ranging from Microsoft ,Google, Facebook, Amazon , Adobe and  many more.
And that is not all ,  PlacementCentral's Placement Predictor predicts the companies you could be placed in the near future  based on your resume and skills.
This really helps you get an idea of how you could improve and work toward getting your dream company .</p></center>
    ...
    <!--<div class="templatemo_reasonbg"></div>-->
        ...
        <div class="container" style="margin-left: 25em;">
            	...
            	<div class="templatemo_clientimage" style="margin-right:5em" >
                
            	  <img src="images/client/6.jpg" alt="client image 4" />
              <span>Sahil Bahl <br> bahlsahil28@gmail.com</span>
                  
			  	</div>
                <div class="templatemo_clientimage" style="margin-right:5em" >
              
  				<img src="images/client/siddharth.jpg" alt="client image 2" />
                                   <span>Siddharth Papreja <br> sid.papreja@hotmail.com</span>
                 </div>
                <div class="templatemo_clientimage">
              
  				<img src="images/client/3.jpg" alt="client image 3" />
                               <span>Angadpreet Singh <br> angadpreet.nagpal@gmail.com</span>  
              
				</div>
				
	        	<div class="templatemo_clientimage" style="margin-right:5em" >
                
            	  <img src="images/client/2.jpg" alt="client image 1" />
              <span>Yagyank Chadha <br> yagyank@gmail.com</span>
